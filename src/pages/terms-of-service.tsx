            ...
            <main className="flex-grow container mx-auto px-6 py-20">
                ...
                {termsOfServiceData.map((section) => (
                    <motion.div
                        ...
                        className="max-w-4xl mx-auto mt-8 bg-white/5 p-6 rounded-xl transition-transform transform hover:scale-105 hover:shadow-lg hover:bg-white/10 cursor-pointer"
